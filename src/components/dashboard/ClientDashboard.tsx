...
export default function ClientDashboard() {
  ...
  const activeRequest = userRequests.find(req => req.status === 'accepted')
          ...
          <div className="lg:col-span-3">
            <Card className="border-0 shadow-xl bg-gradient-to-r from-red-500 to-red-600 text-white overflow-hidden relative">
              ...
              <CardHeader className="text-center relative z-10 pb-4">
                ...
                <CardTitle className="text-3xl font-bold mb-2">¿Tu mascota necesita ayuda urgente?</CardTitle>
              ...
              <CardContent>
                {userRequests.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 text-lg font-medium">No tienes solicitudes</p>
                    <p className="text-gray-400 text-sm mt-1">Tus emergencias aparecerán aquí</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {userRequests.map((request) => (
                      <div key={request.id} className="bg-gradient-to-r from-gray-50 to-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                            ...
                            >
                              ...
                              <span>
                                {request.status === 'pending' ? 'Pendiente' :
                                 ...
                                 request.status === 'rejected' ? 'Rechazada' : 'Completada'}
                              </span>
                            </Badge>
                        ...
                        <div className="text-sm text-gray-600 bg-gray-50 rounded-lg p-3">
                          <p><strong>Síntomas:</strong> {request.pet.symptoms}</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            {activeRequest ? (
              <Card className="border-0 shadow-xl bg-gradient-to-br from-green-500 to-green-600 text-white">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-xl font-bold">Chat Activo</CardTitle>
                ...
                <CardContent>
                  <div className="space-y-3 mb-4">
                    <div className="bg-white/20 rounded-lg p-3 backdrop-blur-sm">
                      ...
                      <p className="text-green-100">{activeRequest.pet.species} - {activeRequest.pet.breed}</p>
                    </div>
                  </div>
                  <Button 
              ...
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-xl font-bold text-gray-900">Sin Chat Activo</CardTitle>
                ...
                <CardContent className="text-center">
                  <p className="text-sm text-gray-500">
                    Cuando un veterinario acepte tu solicitud, podrás chatear aquí
                  </p>
                </CardContent>
              </Card>
            )}
